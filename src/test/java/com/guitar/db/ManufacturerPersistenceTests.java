...
public class ManufacturerPersistenceTests {
	...
	public void testGetActiveManufacturers() throws Exception {
		List<Manufacturer> manufacturers = manufacturerJpaRepository.findByActiveIsTrue();
	...
	public void testGetInactiveManufacturers() throws Exception {
		List<Manufacturer> manufacturers = manufacturerJpaRepository.findByActiveIsFalse();
		assertNotNull(manufacturers);
		assertEquals("Gibson Guitar Corporation", manufacturers.get(0).getName());
	}
